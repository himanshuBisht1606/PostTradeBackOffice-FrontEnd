...
export const ROUTE_CONFIG: RouteConfig[] = [
  ...
  { path: '/account-management/brokers', requiredRoles: [...OPS_ROLES, Role.TenantOwner], label: 'Brokers' },

  { path: '/clearing/trades', requiredRoles: ALL_ROLES, label: 'Trade Book' },
  { path: '/clearing/settlement/batches', requiredRoles: [...OPS_ROLES, ...FINANCE_ROLES], label: 'Settlement Batches' },
  { path: '/clearing/settlement/obligations', requiredRoles: [...OPS_ROLES, ...FINANCE_ROLES], label: 'Obligations' },

  { path: '/finance/ledger', requiredRoles: [...FINANCE_ROLES, Role.Auditor], label: 'Ledger' },
  { path: '/finance/charges', requiredRoles: FINANCE_ROLES, label: 'Charges Config' },

  { path: '/reconciliation', requiredRoles: [...OPS_ROLES, Role.RiskController], label: 'Reconciliation' },
